...
always @(*) begin
    case (Eatual)
        inicial:                                     Eprox = mensurar ? transmite_centena_angulo : inicial;
        // Transmissão do ângulo
        transmite_centena_angulo:                    Eprox = espera_transmissao_centena_angulo;
        espera_transmissao_centena_angulo:           Eprox = envio_pronto ? transmite_dezena_angulo : espera_transmissao_centena_angulo;
        transmite_dezena_angulo:                     Eprox = espera_transmissao_dezena_angulo;
        espera_transmissao_dezena_angulo:            Eprox = envio_pronto ? transmite_unidade_angulo : espera_transmissao_dezena_angulo;
        transmite_unidade_angulo:                    Eprox = espera_transmissao_unidade_angulo;
        espera_transmissao_unidade_angulo:           Eprox = envio_pronto ? transmite_caracter_final_angulo : espera_transmissao_unidade_angulo;
        transmite_caracter_final_angulo:             Eprox = espera_transmissao_caracter_final_angulo;
        espera_transmissao_caracter_final_angulo:    Eprox = envio_pronto ? transmite_centena_distancia : espera_transmissao_caracter_final_angulo;
        // Transmissão da distância
        transmite_centena_distancia:                 Eprox = espera_transmissao_centena;
        espera_transmissao_centena_distancia:        Eprox = envio_pronto ? transmite_dezena_distancia : espera_transmissao_centena_distancia;
        transmite_dezena_distancia:                  Eprox = espera_transmissao_dezena_distancia;
        espera_transmissao_dezena_distancia:         Eprox = envio_pronto ? transmite_unidade_distancia : espera_transmissao_dezena_distancia;
        transmite_unidade_distancia:                 Eprox = espera_transmissao_unidade_distancia;
        espera_transmissao_unidade_distancia:        Eprox = envio_pronto ? transmite_caracter_final_distancia : espera_transmissao_unidade_distancia;
        transmite_caracter_final:                    Eprox = espera_transmissao_caracter_final_distancia;
        espera_transmissao_caracter_final_distancia: Eprox = envio_pronto ? fim : espera_transmissao_caracter_final_distancia;
        fim:                                         Eprox = inicial;
        default: 
            Eprox = inicial;
    endcase
